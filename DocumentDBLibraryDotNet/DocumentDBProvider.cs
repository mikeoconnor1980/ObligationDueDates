...
namespace DocumentDBLibraryDotNet
{
    ...
    public class DocumentDbProvider
    {
        ...
        public IQueryable<T> CreateQuery<T>()
        {
            ...
            return _dbClient.CreateDocumentQuery<T>(_collectionUri);
        }
        ...
        /// <param name="feedOptions"></param>
        /// <returns></returns>
        public IQueryable<T> CreateQuery<T>(string sqlExpression)
        {
            return _dbClient.CreateDocumentQuery<T>(_collectionUri, sqlExpression);
        }
